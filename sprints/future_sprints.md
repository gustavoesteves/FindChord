...
| **F14-A2.1** | Hierarchical Similarity | **📅 FEITO** | Desmembra o `overallSimilarity` em `Identity`, `Functional` e `Surface Similarity`. Transforma a matriz de pesos fixa num `WeightProfile` dinâmico (Tonal, Modal, Experimental). |
...
| **F14-X1** | Structural Skeleton Engine | **📅 FEITO** | Extrai o esqueleto estrutural separando rigorosamente a narrativa em Pilares, Conectores e Decorações. |
