      ...
      <div className="w-full flex flex-col gap-4">
        ...
        {progressionChords.length > 0 ? (
          <div className="relative w-full overflow-x-auto bg-zinc-950 p-4 rounded-2xl border border-zinc-900/60 scrollbar-thin flex flex-col gap-4">
            {/* Control Bar: Player on the left, Export on the right */}
            <div className="flex items-center justify-between gap-4 w-full select-none mb-2 animate-scale-up">
              ...
              <div className="relative flex items-center bg-zinc-900/60 p-1 rounded-xl border border-zinc-800 shadow-inner">
                <button
