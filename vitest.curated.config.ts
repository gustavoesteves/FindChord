...
export default defineConfig({
  test: {
    include: [
      ...
      "scripts/apply-proposal-to-writer.spec.ts",
      ...
      "scripts/cadential-goal-presentation.spec.ts",
      "scripts/capability-manifest.spec.ts",
      ...
      "scripts/formal-section-model-boundary.spec.ts",
      ...
      "scripts/generated-proposal-events.spec.ts",
      ...
      "scripts/writer-ambiguous-chord-selection.spec.ts",
      ...
      "scripts/writer-voicing-shape-filters.spec.ts",
    ]
  }
});
